...
function preload() {
    ...
    this.load.image('paddle', 'static/games/catch/paddle.png');
    this.load.image('ballImage', 'static/games/catch/ball.png');
    this.load.image('area', 'static/games/catch/area.png');
